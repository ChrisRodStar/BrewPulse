...
BrewPulse Free does not collect analytics, telemetry, crash reports, identifiers, or package inventories. It does not require an account and does not send data to a BrewPulse service.
